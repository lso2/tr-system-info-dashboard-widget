<?php
/**
 * Footer Plugin Info Section Template
 * 
...
?>
<!-- Footer Plugin Info Section -->
<div class="tr-plugin-info">
    <div class="tr-plugin-info-content">
 ...
 <a href="https://github.com/lso2/tr-system-info-dashboard-widget" target="_blank">Github</a>
        </div>
        <div class="tr-plugin-support">
            <a href="https://techreader.com/donate" target="_blank" class="tr-mini-donate-btn">☕ Buy Me a Coffee</a>
        </div>
    </div>
</div>
